...
function renderTable(books) {
    ...
    <tr>
    <td>${book.name}</td>
    <td> <button onclick="onUpdateBook('${book.id}')"><img src="img/edit.png"></button>${book.price}</td>
    <td>${book.rate}</td>
...
function updateFilterTxt(filterBy) {
    ...
    document.querySelector('[title="Max Price"]').innerText = filterBy.maxPrice
}
